...
So lets get started. First we will build a simulation of a single particle in a box. As we will see, a gas with properties like temperature and pressure, is actually just a bunch of particles in a box.
"""
